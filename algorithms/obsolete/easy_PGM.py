...
def easy_PGM(data_set, NUM_LA_NEIGHBORS):
    """
    ...
    while continue_iter:
        ...
        for l in reversed(range(len(omega_r))):
            ...
            if sub_obj < best_LP_obj - 1:
                model_improved_count += 1
                print(
    ...
    print(f"Easy PGM finished with {iter_count} solving iterations, {cg_count} columns generated, {model_improved_count} objective improvements, in {round(iter_end_time - iter_start_time, 1)} iteration time.")
